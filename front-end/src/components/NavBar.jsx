      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          <div className="relative">
            ...
            {/* <!-- Dropdown menu --> */}
            <div
                className={`absolute ${isUserDropDownOpen ? "" : "hidden"} right-0 z-50 mt-6 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600`}
                id="user-dropdown"
              >
        ...
        <div
          className={`items-center justify-between ${isNavDropDownOpen ? "" : "hidden"} w-full md:flex md:w-auto md:order-1`}
          id="navbar-user"
        >
